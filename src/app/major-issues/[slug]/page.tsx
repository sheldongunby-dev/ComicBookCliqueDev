...
export async function generateStaticParams() {
    const slugs = await getPodcastSlugsByCategory('major-issues');
...
export default async function MajorIssuesEpisodePage({ params }: Props) {
        ...
        <article className="min-h-screen bg-cbc-surface pb-24">
            ...
            <div className="relative w-full h-[50vh] min-h-[400px] bg-cbc-darker">
                ...
                <div className="absolute top-24 left-4 sm:left-8 z-20">
                    ...
                    >
                        <ArrowLeft size={16} /> Major Issues Hub
                    </Link>
                </div>
            ...
            <div className="relative z-10 -mt-12 px-4 sm:px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mt-16 text-center">
                        ...
                        >
                            Back to Major Issues <ArrowLeft size={16} />
                        </Link>
                    </div>
                </div>
            </div>
